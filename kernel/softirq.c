...
// Joao Abreu patch manual additions - Patch takes it off
//static int ksoftirqd_should_run(unsigned int cpu)
//{
//	return local_softirq_pending();
//}

// Joao Abreu patch manual additions - Patch changes this function
//static void run_ksoftirqd(unsigned int cpu)
...
//
//		return;
// Ta tirando tudo desse unlock wait no patch
#ifdef CONFIG_PREEMPT_RT_FULL
		msleep(1);
#else
		barrier();
